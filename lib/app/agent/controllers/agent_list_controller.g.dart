...
mixin _$AgentListController on _AgentListControllerBase, Store {
  late final _$agentsAtom =
      Atom(name: '_AgentListControllerBase.agents', context: context);
  ...
  late final _$fetchAgentsAsyncAction =
      AsyncAction('_AgentListControllerBase.fetchAgents', context: context);
